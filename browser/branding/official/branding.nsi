...
!define BrandFullName         "CryFox"
!define CompanyName           "cryfox.org"
!define URLInfoAbout          "https://www.cryfox.org"
!define URLUpdateInfo         "https://www.cryfox.org/firefox/${AppVersion}/releasenotes"
...
!define OFFICIAL
!define URLStubDownloadX86 "https://download.cryfox.org/?os=win&lang=${AB_CD}&product=cryfox-latest"
!define URLStubDownloadAMD64 "https://download.cryfox.org/?os=win64&lang=${AB_CD}&product=cryfox-latest"
!define URLStubDownloadAArch64 "https://download.cryfox.org/?os=win64-aarch64&lang=${AB_CD}&product=cryfox-latest"
!define URLManualDownload "https://www.cryfox.org/${AB_CD}/firefox/installer-help/?channel=release&installer_lang=${AB_CD}"
